...
import { computeSnowballPlan } from "../lib/snowball";
...
export function SchuldenabbauTab() {
  ...
  const plan = useMemo(() => computeSnowballPlan(openItemsState.items, new Date()), [openItemsState]);
      ...
      <div className="rounded-xl border border-indigo-200 bg-indigo-50 p-5">
        {plan.hitCap ? (
          <p className="text-sm font-semibold text-red-600">
            Mit den aktuellen Monatsraten ist kein Schuldenfrei-Datum innerhalb von 100 Jahren berechenbar — bitte
            Raten oder Beträge prüfen.
          </p>
        ) : (
          <>
