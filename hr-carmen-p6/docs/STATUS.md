...
Diese Migration deckt **nur P6** ab. Nicht angefasst bzw. nicht entschieden:

1. Reihenfolge/Umfang für P2–P5 und P8 (noch nicht extrahiert, liegen als
   Roh-PDFs/Word-Dateien unter `handoff/source/` im ursprünglichen Zip vor,
   nicht in dieses Repo übernommen).
